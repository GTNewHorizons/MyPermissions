...
public class PermissionProxy {
    ...
    public static void init() {
        if (Config.instance.permissionSystem.get()
            .equals(PERM_SYSTEM_BUKKIT)) {
        ...
        } else if (Config.instance.permissionSystem.get()
            .equals(PERM_SYSTEM_FORGE_ESSENTIALS)) {
                ...
                .equals(PERM_SYSTEM_SERVER_TOOLS)) {
                    ...
                    MyPermissions.instance.LOG
                        .info("This is not fully functional and only works for mods that use this API.");
                    MyPermissions.instance.LOG
                        .info("If you have Bukkit or ForgeEssentials installed please use that instead.");
                }
    }
}
